...
typedef NS_ENUM(NSUInteger, HKPopUpMenuAnimationStyle) {
    HKPopUpMenuAnimationStyleNone,
    HKPopUpMenuAnimationStyleFade,
};


@interface HKPopupMenuItem : NSObject
...
@property (nonatomic, assign) HKPopUpMenuAnimationStyle animationStyle;
