...
- (UIImageView *)photoImageView
{
    if (_photoImageView == nil) {
        ...
        _photoImageView.contentMode = IS_IPAD ? UIViewContentModeScaleAspectFit:UIViewContentModeScaleAspectFill;
...
- (void)setMaxAndMinZoomScales
{
    ...
    if (IS_IPAD) {
        self.photoImageView.xl_width = SCREEN_WIDTH;
        self.photoImageView.xl_height =  SCREEN_HEIGHT;
