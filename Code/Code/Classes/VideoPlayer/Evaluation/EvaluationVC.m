...
@interface EvaluationVC ()<StarViewDelegate,HKCommentContentViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,UICollectionViewDelegate,UICollectionViewDataSource>{
    int i;
}
...
//        CGFloat w = (SCREEN_WIDTH - 10 *2)/3.0;
...
//    [self createUI];
//    
//    self.contentView.hidden = self.isFromLiveVC ? NO : YES;
//}
//
...
//    self.collectionView.hidden = self.isFromLiveVC ? YES : NO;
...
//    [dic setObject:self.videoId forKey:@"video_id"];
//    [dic setObject:score forKey:@"score"];
//    [dic setObject:difficult forKey:@"difficult"];
...
////            }
////            if ([self.delegate respondsToSelector:@selector(evaluationSucess)]) {
////                [self.delegate evaluationSucess];
////            }
