...
/** add 0308  选中加粗字体*/
@property (nonatomic, assign) BOOL isSelectedBold;

/** 所有item 加粗字体*/
@property (nonatomic, assign) BOOL isAllItemBold;
...
@property (nonatomic , strong) UIButton *moreButton;//菜单左侧固定按钮
//@property (nonatomic , assign) BOOL neededRefresh;
