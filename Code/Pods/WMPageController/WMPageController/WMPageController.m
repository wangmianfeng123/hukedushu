...
- (void)wm_addMenuView {
    ...
    // 所有标题加粗
    menuView.isAllItemBold = self.isAllItemBold;
...
//    UIFont *titleFont = self.titleFontName ? [UIFont fontWithName:self.titleFontName size:self.titleSizeSelected] : [UIFont systemFontOfSize:self.titleSizeSelected];
    ...
    UIFont *titleFont = self.titleFontName ? [UIFont fontWithName:self.titleFontName size:self.titleSizeSelected] : [UIFont systemFontOfSize:self.titleSizeSelected weight:UIFontWeightMedium];
...
- (void)menuView:(WMMenuView *)menu didSelesctedIndex:(NSInteger)index currentIndex:(NSInteger)currentIndex {
    ...
    if ([self.delegate respondsToSelector:@selector(pageController:menuView:didSelesctedIndex:currentIndex:)]) {
        [self.delegate pageController:self.currentViewController menuView:menu didSelesctedIndex:index currentIndex:currentIndex];
    }
}
...
/** add menu 背景颜色 */
- (UIColor *)menuView:(WMMenuView *)menu menuColorForState:(WMMenuItemState)state atIndex:(NSInteger)index {
    return self.menuColorNormal;
}
