...
- (id)initWithFrame:(CGRect)frame {
    ...
    if (self) {
        ...
        [self.moreBtn setTitleColor:COLOR_27323F_EFEFF6 forState:UIControlStateNormal];
...
- (__kindof UICollectionViewCell*)collectionView:(UICollectionView*)collectionView cellForItemAtIndexPath:(NSIndexPath*)indexPath {
    ...
    if (self.viewerSendImgEnabled) {
        if (index == 0) {
            [cell.moreBtn setImage:[UIImage imageNamed:@"ic_photo_v2_21"] forState:UIControlStateNormal];
            ...
            [cell.moreBtn setImage:[UIImage imageNamed:@"ic_shoot_v2_21"] forState:UIControlStateNormal];
            ...
            [cell.moreBtn setImage:[UIImage imageNamed:@"ic_placard_v2_21"] forState:UIControlStateNormal];
            ...
            [cell.moreBtn setImage:[UIImage imageNamed:@"ic_people_nomal_v2_21"] forState:UIControlStateNormal];
            [cell.moreBtn setImage:[UIImage imageNamed:@"ic_people_select_v2_21"] forState:UIControlStateSelected];
