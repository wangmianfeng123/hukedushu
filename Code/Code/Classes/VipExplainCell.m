...
- (void)createUI {
    ...
    [_vipInfoLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.left.equalTo(weakSelf.tagLabel.mas_right).offset(PADDING_5);
    }];
    ...
    [@[_studyBtn, _downBtn, _textBtn,_idBtn] mas_distributeViewsAlongAxis:MASAxisTypeHorizontal withFixedSpacing:PADDING_30 leadSpacing:PADDING_20 tailSpacing:PADDING_20];
    ...
    [@[_courseBtn, _commentBtn, _fileBtn, _customerBtn] mas_distributeViewsAlongAxis:MASAxisTypeHorizontal withFixedSpacing:PADDING_30 leadSpacing:PADDING_20 tailSpacing:PADDING_20];
    ...
    if (!_vipInfoLabel) {
        _vipInfoLabel  = [UILabel labelWithTitle:CGRectZero title:@"VIP特权"
                                  titleColor:[UIColor colorWithHexString:@"#333333"]
                                   titleFont:nil titleAligment:NSTextAlignmentLeft];
        _vipInfoLabel.font = [UIFont systemFontOfSize:IS_IPHONE6PLUS ? 19:18];
