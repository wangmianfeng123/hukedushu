 ...
 */
typedef NS_ENUM (NSUInteger, HKCollectionViewWaterfallLayoutItemRenderDirection) {
  HKCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst,
  HKCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight,
  HKCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft
};
 ...
 *  HKCollectionViewWaterfallLayout object to implement a waterfall-based layout.
...
#pragma mark - HKCollectionViewWaterfallLayout

/**
 *  The HKCollectionViewWaterfallLayout class is a concrete layout object that organizes items into waterfall-based grids
 ...
 *
 *  @note HKCollectionViewWaterfallLayout doesn't support decoration view, and it supports vertical scrolling direction only.
 */
 ...
 *  @discussion
 *    The direction in which each item is rendered. This could be left to right (HKCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight), right to left (HKCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft), or shortest column fills first (HKCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst).
 *
 *    Default: HKCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst
 */
@property (nonatomic, assign) HKCollectionViewWaterfallLayoutItemRenderDirection itemRenderDirection;
