...
////  Code
////
////  Created by Ivan li on 2019/6/13.
...
//        _scanRectView.center = self.view.center;
//        _scanRectView.size = CGSizeMake(self.view.width - 60, 300);
//        _scanRectView.backgroundColor = [UIColor redColor];
//    }
...
//    if (!_decodedLabel) {
//        _decodedLabel = [UILabel labelWithTitle:CGRectZero title:@"扫描吧" titleColor:[UIColor blueColor] titleFont:@"12" titleAligment:NSTextAlignmentCenter];
//    }
