...
@class MPVolumeView,LBLelinkKitManager;

@protocol LBLelinkKitManagerDelegate <NSObject>
...
/**
 ...
 @param error 错误信息
 */
- (void)lBLelinkKitManager:(LBLelinkKitManager *)manager onError:(NSError *)error;
 ...
 */
- (void)lBLelinkKitManager:(LBLelinkKitManager *)manager playStatus:(LBLelinkPlayStatus)playStatus;


/**
 连接到设备
 */
- (void)lBLelinkKitManager:(LBLelinkKitManager *)manager isConnect:(BOOL)isConnect;
...
@property (nonatomic,weak) MPVolumeView *volumView;

@property (nonatomic,weak) id <LBLelinkKitManagerDelegate>delegate;
/** 连接的设备名称 */
@property (nonatomic,copy,nullable)NSString *connectDeviceName;

@property (nonatomic,assign)BOOL isConnected;

@property (nonatomic,assign)BOOL isAirPlay;

@property (nonatomic,assign)BOOL isLBlink;
