...
@property (nonatomic, weak) id <HKCollectionViewDelegateWaterfallLayout> delegate;
...
- (void)setItemRenderDirection:(HKCollectionViewWaterfallLayoutItemRenderDirection)itemRenderDirection {
...
- (id <HKCollectionViewDelegateWaterfallLayout> )delegate {
  return (id <HKCollectionViewDelegateWaterfallLayout> )self.collectionView.delegate;
}
...
- (void)commonInit {
  ...
  _itemRenderDirection = HKCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst;
}
...
- (void)prepareLayout {
  ...
  NSAssert([self.delegate conformsToProtocol:@protocol(HKCollectionViewDelegateWaterfallLayout)], @"UICollectionView's delegate should conform to CHTCollectionViewDelegateWaterfallLayout protocol");
...
- (NSUInteger)nextColumnIndexForItem:(NSInteger)item inSection:(NSInteger)section {
  ...
  switch (self.itemRenderDirection) {
    case HKCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst:
      index = [self shortestColumnIndexInSection:section];
      break;

    case HKCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight:
      index = (item % columnCount);
      break;

    case HKCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft:
