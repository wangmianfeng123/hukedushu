...
install_xcframework "${PODS_ROOT}/TXLiteAVSDK_Player/TXLiteAVSDK_Player/TXSoundTouch.xcframework" "TXSoundTouch" "framework" "ios-x86_64-simulator" "ios-arm64_armv7"
install_xcframework "${PODS_ROOT}/TXLiteAVSDK_Player/TXLiteAVSDK_Player/TXFFmpeg.xcframework" "TXFFmpeg" "framework" "ios-x86_64-simulator" "ios-arm64_armv7"
