...
#elif __has_include(<PolyvIJKMediaFramework/PolyvIJKMediaFramework.h>)
...
//!!!播放器私有接口，只提供给PolyvLiveSDK层的播放器子类调用，不提供给Demo层使用
...
/// 加载主播放器
- (void)loadMainPlayer:(NSURL *)url options:(IJKFFOptions *)options;
