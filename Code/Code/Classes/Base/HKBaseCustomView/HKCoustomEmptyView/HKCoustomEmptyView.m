//
//  HKCoustomEmptyView.m
//  Code
//
//  Created by Ivan li on 2019/3/3.
//  Copyright © 2019年 pg. All rights reserved.
//

#import "HKCoustomEmptyView.h"


#define imageTopName @"data_empty"

#define imageTopNetName @"network_lose"
...
@implementation HKCoustomEmptyView
...
- (UIButton *)button {
    if (_button == nil) {
        ...
        button.backgroundColor = [UIColor colorWithRed:249 / 255.0 green:213 / 255.0 blue:72 / 255.0 alpha:1.0];
...
- (void)btnClickEvent:(UIButton *)btn {
    ...
    if (self.imageViewTop.image) {
        ...
        UIActivityIndicatorView *loadingView = [[UIActivityIndicatorView alloc] initWithActivityIndicatorStyle:indicatorViewStyle];
