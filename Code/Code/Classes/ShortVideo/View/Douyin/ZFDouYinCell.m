...
- (void)setData:(ZFTableData *)data {
    _data = data;
    [self.coverImageView sd_setImageWithURL:[NSURL URLWithString:[HKLoadingImageTool transitionImageUrlString:data.thumbnail_url]]  placeholderImage:imageName(@"ZFHKNormalPlayer_bgView")];
    [self.bgImgView sd_setImageWithURL:[NSURL URLWithString:[HKLoadingImageTool transitionImageUrlString:data.thumbnail_url]] placeholderImage:imageName(@"ZFHKNormalPlayer_bgView")];
