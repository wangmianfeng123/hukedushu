...
+(void)setAvatarAndNickName:(PLVChatroomModel*)model{
    model.avatar = [HKAccountTool shareAccount].avator;
    model.nickName = [HKAccountTool shareAccount].username;
}
    ...
    switch (object.eventType) {
        case PLVSocketChatRoomEventType_SPEAK: {
            ...
            if (object.isLocalMessage) { // 本地发言
                ...
                [self setAvatarAndNickName:model];
            }else {
    ...
    switch (self.type) {
        ...
        case PLVChatroomModelTypeSpeakOwnCensor: {
            ...
            //[(PLVChatroomSpeakOwnCell *)cell setSpeakContent:self.speakContent];
                [(PLVChatroomSpeakOwnCell *)cell setActor:self.actor];
                [(PLVChatroomSpeakOwnCell *)cell setAvatar:self.avatar];
                [(PLVChatroomSpeakOwnCell *)cell setNickName:self.nickName];
                [(PLVChatroomSpeakOwnCell *)cell setActorTextColor:self.actorTextColor];
                [(PLVChatroomSpeakOwnCell *)cell setActorBackgroundColor:self.actorBackgroundColor];
                [(PLVChatroomSpeakOwnCell *)cell setSpeakContent:self.speakContent admin:self.isTeacher];
        ...
        case PLVChatroomModelTypeImageSend: {
            ...
            [(PLVChatroomImageSendCell *)cell setAvatar:self.avatar];
            [(PLVChatroomImageSendCell *)cell setActor:self.actor];
            [(PLVChatroomImageSendCell *)cell setNickName:self.nickName];
