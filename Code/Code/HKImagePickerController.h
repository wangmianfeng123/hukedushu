 ...
 *  获取图片 代理
 */
@protocol HKImagePickerControllerDelegate <NSObject>
@optional
/**
 *  不缓存状态下的图片回调
 *
...
@interface HKImagePickerController : NSObject
 ...
 *  选取图片结束的代理
 */
@property (nonatomic,weak) id<HKImagePickerControllerDelegate>delegate;
