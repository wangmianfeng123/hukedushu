...
+ (void)changeDeviceOrientation:(UIDeviceOrientation)orientation {
    ...
    if(@available(iOS 16.0, *)){
        UINavigationController *nav = [CommonFunction topViewController].navigationController;
        ...
        UIInterfaceOrientationMask orition;
        if(orientation == UIDeviceOrientationPortrait){
            orition = UIInterfaceOrientationMaskPortrait;
            
        }else if (orientation == UIDeviceOrientationLandscapeLeft){
            orition = UIInterfaceOrientationMaskLandscapeLeft;
            
        }else if (orientation == UIDeviceOrientationLandscapeRight){
            orition = UIInterfaceOrientationMaskLandscapeRight;
            
        }else if (orientation == UIDeviceOrientationPortraitUpsideDown){
            orition = UIInterfaceOrientationMaskPortraitUpsideDown;
        }else{
            orition = UIInterfaceOrientationMaskAllButUpsideDown;
        }
        
        geometryPreferences.interfaceOrientations = orition;
