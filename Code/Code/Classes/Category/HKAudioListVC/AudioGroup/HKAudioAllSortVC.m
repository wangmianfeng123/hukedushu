...
@interface HKAudioAllSortVC ()<TBSrollViewEmptyDelegate, UITableViewDelegate,UITableViewDataSource>
...
@implementation HKAudioAllSortVC
...
//    model.play_num =@"111";
//    model.duration =@"11";
//    model.cover_url = @"https://pic.huke88.com/video/cover/2018-03-07/E7A099CF-8359-DDE1-190F-724E94B173BF.jpg!/fw/432/format/webp";
...
//    VideoModel *musicModel = [VideoModel new];
//    musicModel.audio_id = @"110";
//    musicModel.title = @"基金";
...
- (void)sortVideoByPage:(NSString*)page {
    ...
    [self filterVideoListWithClassName:nil sort:nil page:page tag1:nil];
}
...
//    [parameters setValue:page forKey:@"page"];
    ...
    [parameters setValue:@"0" forKey:@"class_id"];
    [parameters setValue:@"0" forKey:@"sort"];
