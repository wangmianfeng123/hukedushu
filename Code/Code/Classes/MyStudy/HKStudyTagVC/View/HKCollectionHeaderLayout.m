...
@interface HKCollectionHeaderLayout()
...
@implementation HKCollectionHeaderLayout
...
- (CGFloat)countItemSizeWithIndexPath:(NSIndexPath *)indexPath {
    ...
    return MAX(size.width + self.itemContentMargin*2, self.itemHeight);
