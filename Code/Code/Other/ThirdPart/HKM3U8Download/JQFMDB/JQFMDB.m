...
- (NSString *)propertTypeConvert:(NSString *)typeStr
{
    ...
    if ([typeStr hasPrefix:@"T@\"NSString\""]) {
        ...
        resultStr = SQL_BLOB;
    } else if ([typeStr hasPrefix:@"Ti"]||[typeStr hasPrefix:@"TI"]||[typeStr hasPrefix:@"Ts"]||[typeStr hasPrefix:@"TS"]||[typeStr hasPrefix:@"T@\"NSNumber\""]||[typeStr hasPrefix:@"TB"]||[typeStr hasPrefix:@"Tq"]||[typeStr hasPrefix:@"TQ"] ||[typeStr hasPrefix:@"TC"] ||[typeStr hasPrefix:@"Tc"]) {
...
- (NSArray *)getColumnArr:(NSString *)tableName db:(FMDatabase *)db
{
    ...
    if (self.tableDic[tableName]) {
        mArr = self.tableDic[tableName];
    } else {
