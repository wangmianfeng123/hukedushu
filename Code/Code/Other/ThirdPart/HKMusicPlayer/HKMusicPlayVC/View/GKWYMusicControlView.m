...
@property (nonatomic, strong) HKMusicPlayLoadView *loadView;
...
- (void)setupPlayBtn {
    //加载 旋转
    [self.playBtn setImage:[UIImage imageNamed:@"music_play"] forState:UIControlStateNormal];
    [self.playBtn setImage:[UIImage imageNamed:@"music_play"] forState:UIControlStateHighlighted];
}

- (void)setupPauseBtn {
    [self.playBtn setImage:[UIImage imageNamed:@"music_pause"] forState:UIControlStateNormal];
    [self.playBtn setImage:[UIImage imageNamed:@"music_pause"] forState:UIControlStateHighlighted];
}
...
- (UIButton *)playBtn {
    if (!_playBtn) {
        ...
        [_playBtn setImage:[UIImage imageNamed:@"music_pause"] forState:UIControlStateNormal];
        [_playBtn setImage:[UIImage imageNamed:@"music_pause"] forState:UIControlStateHighlighted];
...
- (UILabel *)currentLabel {
    if (!_currentLabel) {
        ...
        _currentLabel.textColor = COLOR_666666;
...
- (UILabel *)totalLabel {
    if (!_totalLabel) {
        ...
        _totalLabel.textColor = COLOR_999999;
...
- (HKMusicPlayLoadView *)loadView {
    if (!_loadView) {
        _loadView = [[HKMusicPlayLoadView alloc] init];
...
- (GKSliderView *)slider {
    if (!_slider) {
        _slider = [[GKSliderView alloc]initWithFrame:CGRectZero progressMargin:5];
        
        NSString *point =  @"music_red_point";
        
        NSString *speedBg = @"music_speed_bg";
        
        NSString *speedLoad = @"music_speed_load";
        
        NSString *speedBuff = @"music_speed_buff";
        
        [_slider setBackgroundImage:[UIImage imageNamed:point] forState:UIControlStateNormal];
        [_slider setBackgroundImage:[UIImage imageNamed:point] forState:UIControlStateSelected];
        [_slider setBackgroundImage:[UIImage imageNamed:point] forState:UIControlStateHighlighted];
        
        [_slider setThumbImage:[UIImage imageNamed:point] forState:UIControlStateNormal];
        [_slider setThumbImage:[UIImage imageNamed:point] forState:UIControlStateSelected];
        [_slider setThumbImage:[UIImage imageNamed:point] forState:UIControlStateHighlighted];
        
        _slider.maximumTrackImage = [UIImage imageNamed:speedBg];
        _slider.minimumTrackImage = [UIImage imageNamed:speedLoad];
        _slider.bufferTrackImage = [UIImage imageNamed:speedBuff];
        _slider.delegate = self;
        _slider.sliderHeight = 5;
