...
-(void)setupUI{
    ...
    switch (_style) {
        case InputViewStyleDefault:{
            ...
            _inputView.frame = CGRectMake(0, SCREEN_HEIGHT, SCREEN_WIDTH, HKInputView_StyleDefault_Height);
            
            self.countBtn.frame = CGRectMake(HKInputView_StyleDefault_LRSpace, 15, 15, 22);
            ...
            _sendButton.frame = CGRectMake(SCREEN_WIDTH - HKInputView_StyleDefault_LRSpace - sendButtonWidth, 13,sendButtonWidth, sendButtonHeight);
            ...
            CGFloat X =  self.countBtn.x+self.countBtn.width+20;
            _textView = [[UITextView alloc] initWithFrame:CGRectMake(X, HKInputView_StyleDefault_TBSpace, _sendButton.x-(X)-10, self.inputView.bounds.size.height - 2*HKInputView_StyleDefault_TBSpace)];
            
            _textView.font = HK_FONT_SYSTEM(14);
            _textView.clipsToBounds = YES;
            _textView.layer.cornerRadius = 15;
            //_textView.textContainerInset = UIEdgeInsetsMake(0, 15, 0, 15);
            ...
            _placeholderLab = [[UILabel alloc] initWithFrame:CGRectMake(7, 0, _textView.bounds.size.width-15, _textView.bounds.size.height)];
        ...
        case InputViewStyleLarge:{
            ...
            _sendButton = [UIButton buttonWithType:UIButtonTypeCustom];
            _sendButton.frame = CGRectMake(SCREEN_WIDTH - HKInputView_StyleLarge_LRSpace - sendButtonWidth, self.inputView.frame.size.height - HKInputView_StyleLarge_TBSpace - sendButtonHeight, sendButtonWidth, sendButtonHeight);
            ...
            _textBgView = [[UIView alloc] initWithFrame:CGRectMake(HKInputView_StyleLarge_LRSpace, HKInputView_StyleLarge_TBSpace, SCREEN_WIDTH-2*HKInputView_StyleLarge_LRSpace, CGRectGetMinY(_sendButton.frame)-2*HKInputView_StyleLarge_TBSpace)];
    ...
    if(object == _textView && [keyPath isEqualToString:@"contentSize"]){
        ...
        if(height >= heightDefault){
            ...
            [UIView animateWithDuration:0.3 animations:^{
                ...
                //调整sendButton frame
//                _sendButton.frame = CGRectMake(SCREEN_WIDTH - HKInputView_StyleDefault_LRSpace - _sendButton.frame.size.width, _inputView.bounds.size.height - _sendButton.bounds.size.height - HKInputView_StyleDefault_TBSpace, _sendButton.bounds.size.width, _sendButton.bounds.size.height);
//
//                //调整textView frame
//                _textView.frame = CGRectMake(HKInputView_StyleDefault_LRSpace, HKInputView_StyleDefault_TBSpace, _textView.bounds.size.width, _inputView.bounds.size.height - 2*HKInputView_StyleDefault_TBSpace);
                ...
                self.countBtn.frame = CGRectMake(HKInputView_StyleDefault_LRSpace, _inputView.bounds.size.height - _countBtn.bounds.size.height - 15, 15, 22);
                
                CGFloat sendButtonWidth = 35;
                CGFloat sendButtonHeight = 24;
                
                _sendButton.frame = CGRectMake(SCREEN_WIDTH - HKInputView_StyleDefault_LRSpace - sendButtonWidth, _inputView.bounds.size.height - _sendButton.bounds.size.height - 13,sendButtonWidth, sendButtonHeight);

                CGFloat X =  self.countBtn.x+self.countBtn.width+20;
                _textView.frame = CGRectMake(X, HKInputView_StyleDefault_TBSpace, _sendButton.x-(X)-10, self.inputView.bounds.size.height - 2*HKInputView_StyleDefault_TBSpace);
...
-(void)textViewDidChange:(UITextView *)textView{
    if(textView.text.length){
        ...
        [_sendButton setTitleColor:COLOR_3D8BFF forState:UIControlStateNormal];
    }else{
        _placeholderLab.hidden = NO;
        [_sendButton setTitleColor:COLOR_7B8196 forState:UIControlStateNormal];
    }
...
- (void)setCommentCount:(NSString *)commentCount {
    ...
    self.countBtn.count = commentCount;
}
