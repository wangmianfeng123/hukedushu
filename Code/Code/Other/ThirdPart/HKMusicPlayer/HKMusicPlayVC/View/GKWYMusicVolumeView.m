...
- (void)layoutSubviews {
    ...
    self.volumeView.x      = self.volImageView.right + 10;
    self.volumeView.width  = self.width - self.volumeView.x - 5;
    self.volumeView.height = 36;
    self.volumeView.centerY = self.height * 0.5;
}
