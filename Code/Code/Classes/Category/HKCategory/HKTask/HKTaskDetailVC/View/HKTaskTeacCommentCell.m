...
//        make.top.equalTo(self.scanImageLB.mas_bottom).offset(50);
...
//    if (sender.selected) {
//        [sender setTitle:@"11" forState:UIControlStateSelected];
//        [_praiseBtn layoutButtonWithEdgeInsetsStyle:HKButtonEdgeInsetsStyleTop imageTitleSpace:0];
//    }
//}
...
- (void)setModel:(HKTaskDetailModel *)model {
    ...
    [self.teacCommentIV sd_setImageWithURL:HKURL(model.modify_picture_url) placeholderImage:HK_PlaceholderImage
