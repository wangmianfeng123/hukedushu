...
@property (nonatomic,strong)NSMutableArray <HKTagModel*>*cerArray;//上下轮播数据
...
- (NSMutableArray <HKTagModel*>*)cerArray {
    if (!_cerArray) {
        _cerArray = [NSMutableArray array];
    }
    return _cerArray;
}
...
- (UICollectionView*)contentCollectionView {
    if (!_contentCollectionView) {
        ...
        [_contentCollectionView registerNib:[UINib nibWithNibName:NSStringFromClass([HKSoftCycleVerticalCell class]) bundle:nil] forCellWithReuseIdentifier:NSStringFromClass([HKSoftCycleVerticalCell class])];
//        [_contentCollectionView registerClass:[HKSoftCycleVerticalCell class] forSupplementaryViewOfKind:UICollectionElementKindSectionFooter withReuseIdentifier:NSStringFromClass([HKSoftCycleVerticalCell class])];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (sectionCount && indexPath.section == sectionCount - 1 && self.cerArray.count) {
        HKSoftCycleVerticalCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([HKSoftCycleVerticalCell class]) forIndexPath:indexPath];
        cell.dataArray = self.cerArray;
        cell.itemClickBlock = ^(HKUserFetchCerModel * _Nonnull model) {
...
- (CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.section == 0 && self.isShowOpenVipCell) {
...
static CGFloat const kWMHeaderViewHeight = 252+44;
...
- (void)prepareSetup {
    ...
    if (!self.cerArray.count) {
        self.maximumHeaderViewHeight -= 44;
    }
...
- (void)getSoftwareList{
    ...
    [HKHttpTool POST:VIDEO_SOFTWARE_HEADER_INFO parameters:nil success:^(id responseObject) {
        ...
        if (HKReponseOK) {
            ...
            self.cerArray = [HKUserFetchCerModel mj_objectArrayWithKeyValuesArray:responseObject[@"data"][@"achievementsList"]];
