...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TBScrollViewEmpty/TBScrollViewEmpty.framework"
  ...
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TXSoundTouch/TXSoundTouch.framework"
  install_framework "${PODS_XCFRAMEWORKS_BUILD_DIR}/TXFFmpeg/TXFFmpeg.framework"
fi
