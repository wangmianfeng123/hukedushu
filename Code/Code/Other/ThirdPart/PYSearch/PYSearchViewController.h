 ...
 */
@protocol PYSearchViewControllerDelegate <NSObject, UITableViewDataSource>
...
@property (nonatomic, copy) NSMutableArray<NSString *> *hisSearches;
...
/**
 ...
 @param hotSearches     popular searchs
 @param searchHistories     history searchs
 @param placeholder     placeholder of search bar
 @return new instance of `PYSearchViewController` class
 */
+ (instancetype)searchViewControllerWithHotSearches:(NSArray<NSString *> *)hotSearches
                               withSearchsearchHistories:(NSMutableArray<NSString *> *)searchHistories;
