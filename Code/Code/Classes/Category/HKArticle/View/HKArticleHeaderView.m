...
@implementation HKArticleHeaderView
...
- (void)awakeFromNib {
    ...
    [self.likeBtn layoutButtonWithEdgeInsetsStyle:HKButtonEdgeInsetsStyleTop imageTitleSpace:5];
