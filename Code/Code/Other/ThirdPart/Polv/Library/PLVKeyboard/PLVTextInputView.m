...
#define polv_placeholderContent @"快来一起讨论吧~"
...
- (void)loadViews:(PLVTextInputViewType)type enableMore:(BOOL)enableMore {
    ...
    if (self.textView == nil) {
        ...
        UIColor *lightColor = [UIColor colorWithRed:245.0 / 255.0 green:245.0 / 255.0 blue:247.0 / 255.0 alpha:1.0];
        self.backgroundColor = [UIColor hkdm_colorWithColorLight:lightColor dark:COLOR_3D4752];
        ...
        self.textView.backgroundColor = COLOR_FFFFFF_333D48;
...
//        self.textView.placeholderContent = [[NSMutableAttributedString alloc] initWithString:polv_placeholderContent attributes:@{NSFontAttributeName : self.textView.plvFont, NSParagraphStyleAttributeName : paragraphStyle, NSForegroundColorAttributeName : COLOR_A8ABBE_7B8196}];
        
        self.textView.placeholderContent = [[NSMutableAttributedString alloc] initWithString:polv_placeholderContent attributes:@{NSFontAttributeName : self.textView.plvFont, NSParagraphStyleAttributeName : paragraphStyle, NSForegroundColorAttributeName : [UIColor lightGrayColor]}];
...
- (BOOL)textViewShouldBeginEditing:(UITextView *)textView {
    if ([self textInputViewShouldBeginEditing]) {
        ...
        //}
        if (self.textView.textColor == [UIColor lightGrayColor]) {
            self.textView.tintColor = COLOR_27323F_EFEFF6;
            self.textView.attributedText = self.textView.emptyContent;
        }
        self.textView.textColor = COLOR_27323F_EFEFF6;
